...
## Resumen del Curso
Este curso introduce a estudiantes de secundaria al desarrollo web utilizando HTML y CSS mediante ejemplos sencillos y prácticos. Los estudiantes aprenderán a crear una página web de perfil personal usando herramientas completamente gratuitas y en línea.

* **Duración total:** ~60 minutos
* **Público objetivo:** Estudiantes de 12 a 17 años sin experiencia previa en programación.
* **Prerrequisitos:** Ninguno.
* **Herramientas necesarias:** Navegador web (Chrome, Firefox, Edge o Safari) y editores de código en línea (CodePen, JSFiddle, Replit).

**Repositorio de código fuente:** [https://github.com/upc-pre-202610-1asi0730-12144-lcortisol/webdev-course-lowcortisol](https://github.com/upc-pre-202610-1asi0730-12144-lcortisol/webdev-course-lowcortisol)
...
* **Código Fuente Completo:** Accede al registro de soluciones desarrolladas en nuestro [Repositorio de GitHub](https://github.com/upc-pre-202610-1asi0730-12144-lcortisol/webdev-course-lowcortisol).
* **Guía de Consulta Rápida:** Tabla interactiva para saltar directamente a los entornos prácticos sin necesidad de registros previos:

| Lección | Actividad Instruccional | Editor en Línea |
| :---: | :--- | :--- |
| 1 | Conceptos Fundamentales | [CodePen](https://codepen.io/tu-lesson1) |
| 2 | Componentes y Atributos HTML | [CodePen](https://codepen.io/tu-lesson2) |
| 3 | Títulos y Párrafos | [CodePen](https://codepen.io/tu-lesson3) |
| 4 | Listas, Imágenes y Enlaces | [CodePen](https://codepen.io/tu-lesson4) |
| 5 | Estructura Inicial de CSS | [CodePen](https://codepen.io/tu-lesson5) |
| 6 | Propiedades Visuales de Diseño | [CodePen](https://codepen.io/tu-lesson6) |
| 7 | Maquetación del Proyecto de Perfil | [CodePen](https://codepen.io/@tu-lesson7) |
| 8 | Retroalimentación de Errores | [CodePen](https://codepen.io/tu-quiz) |
...
* **Nombre del equipo:** lowcortisol
* **Líder del equipo:** James Caleb Delgado Perez
* **Integrantes del equipo:**
  - James Caleb Delgado Perez
  - Kirk Douglas Quiliano Motta
  - Bruno Rodrigo Montalvo Vasquez
  - Miguel Anibal Condori Torres
